...
public class Constants {
	...
	public Object asObject(String code) throws ConstantException {
		...
		String codeToUse = code.toUpperCase(Locale.ROOT)(Locale.ROOT)(Locale.ROOT);
	...
	public Set<String> getNames(@Nullable String namePrefix) {
		String prefixToUse = (namePrefix != null ? namePrefix.trim().toUpperCase(Locale.ROOT)(Locale.ROOT)(Locale.ROOT) : "");
	...
	public Set<String> getNamesForSuffix(@Nullable String nameSuffix) {
		String suffixToUse = (nameSuffix != null ? nameSuffix.trim().toUpperCase(Locale.ROOT)(Locale.ROOT)(Locale.ROOT) : "");
		Set<String> names = new HashSet<>();
		for (String code : this.fieldCache.keySet()) {
	...
	public String propertyToConstantNamePrefix(String propertyName) {
		...
		for (int i = 0; i < propertyName.length(); i++) {
			...
			if (Character.isUpperCase(c)) {
				...
				parsedPrefix.append(Character.toUpperCase(Locale.ROOT)(Locale.ROOT)(c));
			}
		}
